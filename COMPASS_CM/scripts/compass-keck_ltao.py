...
## @brief     script test to simulate a closed loop (with the Keck LTAO Mode)
...
if __name__ == "__main__":
    ...
    if arguments["--zenith"]:
        ...
        supervisor.config.p_wfs0.set_gsalt(supervisor.config.p_wfs0.get_gsalt() / math.cos(z * math.pi / 180))
        supervisor.config.p_wfs1.set_gsalt(supervisor.config.p_wfs1.get_gsalt() / math.cos(z * math.pi / 180))
        supervisor.config.p_wfs2.set_gsalt(supervisor.config.p_wfs2.get_gsalt() / math.cos(z * math.pi / 180))
        supervisor.config.p_wfs3.set_gsalt(supervisor.config.p_wfs3.get_gsalt() / math.cos(z * math.pi / 180))
