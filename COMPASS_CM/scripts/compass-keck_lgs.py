...
## @brief     script test to simulate a closed loop (with the Keck LGS Mode)
...
if __name__ == "__main__":
    ...
    # supervisor.getStrehl(0)[1] provides the long exposure SR, which together with ZA is written into the CSV file
