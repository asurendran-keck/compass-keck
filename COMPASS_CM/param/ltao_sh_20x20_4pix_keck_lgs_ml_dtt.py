...
p_atmos.set_r0(0.16)
#p_atmos.set_r0(p_atmos.get_r0() * (math.cos(z * math.pi / 180)) ** 0.6) # Fried parameter compensated for zenith angle
...
p_wfs0.set_gsmag(9) # In Sec 5.2.8 from KAON 1240 (reduced by 1.5 for power reduced by 4)
...
p_wfs1.set_nxsub(20)
p_wfs1.set_npix(4)
p_wfs1.set_pixsize(1.5)
p_wfs1.set_fracsub(0.5)
p_wfs1.set_xpos(-4.6)
p_wfs1.set_ypos(4.6)
p_wfs1.set_Lambda(0.589)
p_wfs1.set_gsmag(9) # In Sec 5.2.8 from KAON 1240 (reduced by 1.5 for power reduced by 4)
p_wfs1.set_optthroughput(0.36) #In Table 14 from KAON 1240
...
p_wfs2.set_nxsub(20)
p_wfs2.set_npix(4)
p_wfs2.set_pixsize(1.5)
p_wfs2.set_fracsub(0.5)
p_wfs2.set_xpos(-4.6)
p_wfs2.set_ypos(-4.6)
p_wfs2.set_Lambda(0.589)
p_wfs2.set_gsmag(9) # In Sec 5.2.8 from KAON 1240 (reduced by 1.5 for power reduced by 4)
p_wfs2.set_optthroughput(0.36) #In Table 14 from KAON 1240
...
p_wfs3.set_nxsub(20)
p_wfs3.set_npix(4)
p_wfs3.set_pixsize(1.5)
p_wfs3.set_fracsub(0.5)
p_wfs3.set_xpos(4.6)
p_wfs3.set_ypos(-4.6)
p_wfs3.set_Lambda(0.589)
p_wfs3.set_gsmag(9) # In Sec 5.2.8 from KAON 1240 (reduced by 1.5 for power reduced by 4)
p_wfs3.set_optthroughput(0.36) #In Table 14 from KAON 1240
...
#p_wfs0.set_gsalt(gsalt0 / math.cos(z * math.pi / 180)) # GS altitude compensated for zenith angle
p_wfs0.set_lltx(0)
p_wfs0.set_llty(0)
p_wfs0.set_laserpower(5) # From Keck TOPTICA specs
...
#p_wfs1.set_gsalt(gsalt1 / math.cos(z * math.pi / 180)) # GS altitude compensated for zenith angle
p_wfs1.set_lltx(0)
p_wfs1.set_llty(0)
p_wfs1.set_laserpower(5) # From Keck TOPTICA specs
p_wfs1.set_lgsreturnperwatt(60.5) # Converted from Mph/m^2/s in Sec 5.2.8 from KAON 1240
#p_wfs0.set_proftype("gauss")
p_wfs1.set_beamsize(1.7) # From K2 LGS AO metrics in Sec 5.3.1 from KAON 1240

p_wfs2.set_gsalt(90*1.e3)
#p_wfs2.set_gsalt(gsalt2 / math.cos(z * math.pi / 180)) # GS altitude compensated for zenith angle
p_wfs2.set_lltx(0)
p_wfs2.set_llty(0)
p_wfs2.set_laserpower(5) # From Keck TOPTICA specs
p_wfs2.set_lgsreturnperwatt(60.5) # Converted from Mph/m^2/s in Sec 5.2.8 from KAON 1240
#p_wfs0.set_proftype("gauss")
p_wfs2.set_beamsize(1.7) # From K2 LGS AO metrics in Sec 5.3.1 from KAON 1240

p_wfs3.set_gsalt(90*1.e3)
#p_wfs3.set_gsalt(gsalt3 / math.cos(z * math.pi / 180)) # GS altitude compensated for zenith angle
p_wfs3.set_lltx(0)
p_wfs3.set_llty(0)
p_wfs3.set_laserpower(5) # From Keck TOPTICA specs
p_wfs3.set_lgsreturnperwatt(60.5) # Converted from Mph/m^2/s in Sec 5.2.8 from KAON 1240
#p_wfs0.set_proftype("gauss")
p_wfs3.set_beamsize(1.7) # From K2 LGS AO metrics in Sec 5.3.1 from KAON 1240
...
p_centroider4 = conf.Param_centroider()
p_centroiders = [p_centroider0, p_centroider1, p_centroider2, p_centroider3, p_centroider4]
...
p_centroider4.set_nwfs(4)
p_centroider4.set_type("cog")
...
p_controller0.set_nwfs([0,1,2,3,4])
p_controller0.set_ndm([0,1]) #CHECK
